...
dataTile = ['ELECTROINGENIERIA SA','TARJETAS REGIONALES SA','FIDEICOMISO EDISUR 1','GRUPO ELING SA','CEMENTOS AVELLANEDA S.A.','GAMA  S.A.','HUAWEI TECH INVESTMENT CO LTD','ASOC. GREM. EMPL. DE COMERCIO','MASSALIN PARTICULARES SRL','PIRELLI NEUMATICOS SAIC','EDISUR S.A.'];
...
chartGroup.append('g').attr('class', 'axis X').call(xAxis).attr('transform', 'translate(0, '+ height +')');
